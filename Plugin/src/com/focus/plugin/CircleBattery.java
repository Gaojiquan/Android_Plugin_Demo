...
public class CircleBattery extends ImageView {
	...
	class SettingsObserver extends ContentObserver {
		...
		public void observe() {
			...
			resolver.registerContentObserver(
					Settings.System.getUriFor(STATUS_BAR_BATTERY), false, this);
			resolver.registerContentObserver(
	...
	public CircleBattery(Context context, AttributeSet attrs, int defStyle) {
		...
		mBakPaint.setAlpha(getResources().getInteger(
				R.integer.config_float_sys_bar_alpha));
	...
	private void initSizeMeasureIconHeight() {
		...
		int defaultSize = getResources().getInteger(
				R.integer.config_float_sys_bar_radius);
		mCircleSize = Settings.System.getInt(mContext.getContentResolver(),
				CIRCLE_SIZE, defaultSize);
